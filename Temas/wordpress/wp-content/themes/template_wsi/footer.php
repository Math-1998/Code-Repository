...
<footer id="footer" class="py-5">
    <div class="container-lg">
        <div class="row row-cols-1 row-cols-lg-2">
            <div class="col">
                <p><strong>© <?= date('Y'); ?></strong> Todos os Direitos Reservados: Renascence Dermatologia. Desenvolvido e Gerenciado por <a title="Agência de Marketing Médico WSI" target="_blank" href="https://medico.wsidm.com.br/">Agência de Marketing Médico WSI</a></p>
            </div>
            <div class="col">
